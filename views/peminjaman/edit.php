            ...
            <div class="card-body">
                <form method="POST">
                    <?php
                        if(isset($_GET['id'])) {
                            $id = $_GET['id'];
                            $sql = $conn->query("SELECT * FROM peminjaman WHERE id_peminjaman='$id'");
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="tgl_pinjam" id="exampleFormControlInput1" value="<?php echo isset($_POST['tgl_pinjam']) ? $_POST['tgl_pinjam'] : $data['tanggal_pinjam']; ?>"required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Tanggal Kembali</label>
                        <input type="date" class="form-control" name="tgl_kembali" id="exampleFormControlInput1" value="<?php echo isset($_POST['tgl_kembali']) ? $_POST['tgl_kembali'] : $data['tanggal_kembali']; ?>" required>
                    </div>
                    <div class="mb-3">
...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "UPDATE peminjaman SET tanggal_pinjam='$tgl_pinjam', tanggal_kembali='$tgl_kembali', id_buku='$buku', id_mahasiswa='$mahasiswa', id_petugas='$petugas' WHERE id_peminjaman='$id'";
